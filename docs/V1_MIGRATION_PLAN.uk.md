...
Цей контрольний список визначає готовність до `v2.1.0.1`. Позначені виконаними
...
- [ ] Додати версійні release notes `v2.1.0.1` і фінальний package inventory.
- [ ] Установити `VERSION` у `1.0.1` і використати repository tag `v2.1.0.1`.
- [ ] Пройти повний native gate на точному pushed release commit.
- [ ] Опублікувати незмінний `v2.1.0.1` і завершити post-release verification на
      чистому host.
