...
Старі документи `*_UK.md` описують опубліковану лінію `iros2-0` 0.1.x. Вони
залишаються історичною експлуатаційною документацією та не визначають цільову
архітектуру `iros2j` v1.
